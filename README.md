...
## <br>---<br>
## 🔧 What I Work With<br>
- **Backend:** Node.js, NestJS, FastAPI<br>
- **Databases:** MongoDB, MySQL, Redis<br>
- **Architecture:** REST APIs, real-time systems, microservices<br>
- **Infra & Tools:** Docker, GitHub Actions, CI/CD<br>
- **Mindset:** Scalability, reliability, maintainability<br><br>---<br><br>

## 🚀 Featured Projects<br>
### 🔹 Realtime Matchmaking and one to one Messaging system<br>
- Built with NestJS & Redis<br>
- Handles real-time user matching with queue management<br>
- Focus on performance, concurrency, and fault tolerance<br>
...
### 🔹 AI Assistant Backend<br>
- API-driven backend integrating AI workflows<br>
